...
public class TestGameOver {
    ...
    public void setUp() {
        ...
        blueS = new Player(gameS, 'B');
        blueG = new Player(gameG, 'B');
        redS = new Player(gameS, 'R');
        redG = new Player(gameG, 'R');
    }

	// AC 5.1 - a simple game ends with a blue win
	@Test
	public void testSimpleWinbyBlue() {
		blueS.makeMove(0, 0, playerPieces);
		redS.makeMove(1, 1, playerPieces);
		blueS.makeMove(2, 2, playerPieces);
	...
	public void testSimpleWinbyRed() {
		blueS.makeMove(0, 0, playerPieces);
		redS.makeMove(0, 1, playerPieces);
		blueS.makeMove(2, 2, playerPieces);
		redS.makeMove(1, 1, playerPieces);
	...
	public void testTiedSimpleGame() {
		blueS.makeMove(0, 0, playerPieces);
		redS.makeMove(0, 2, playerPieces);
		blueS.makeMove(0, 1, playerPieces);
		redS.makeMove(1, 2, playerPieces);
		blueS.makeMove(1, 1, playerPieces);
		redS.makeMove(1, 0, playerPieces);
		blueS.makeMove(2, 1, playerPieces);
		redS.makeMove(2, 0, playerPieces);
		blueS.makeMove(2, 2, playerPieces);
	...
	public void testGeneralGameOverPlayerWin() {
		blueG.makeMove(0, 0, playerPieces);
		redG.makeMove(1, 1, playerPieces);
		blueG.makeMove(2, 2, playerPieces);
		redG.makeMove(1, 0, playerPieces);
		blueG.makeMove(2, 0, playerPieces);
		redG.makeMove(0, 1, playerPieces);
		blueG.makeMove(0, 2, playerPieces);
		redG.makeMove(1, 2, playerPieces);
		blueG.makeMove(2, 1, playerPieces);
	...
	public void testGeneralGameOverDraw() {
		blueG.makeMove(0, 0, playerPieces);
		redG.makeMove(0, 2, playerPieces);
		blueG.makeMove(0, 1, playerPieces);
		redG.makeMove(1, 0, playerPieces);
		blueG.makeMove(1, 1, playerPieces);
		redG.makeMove(1, 2, playerPieces);
		blueG.makeMove(2, 1, playerPieces);
		redG.makeMove(2, 0, playerPieces);
		blueG.makeMove(2, 2, playerPieces);
	...
	public void testGeneralContinueAfterSOS() {
		blueG.makeMove(0, 0, playerPieces);
		redG.makeMove(1, 1, playerPieces);
		blueG.makeMove(2, 2, playerPieces);		// makes SOS
